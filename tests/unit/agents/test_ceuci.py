...
def ceuci_agent(mock_cultural_service):
    with patch("src.agents.ceuci.CulturalAnalysisService", return_value=mock_cultural_service):
...
class TestCeuciAgent:
    ...
    async def test_cultural_analysis(self, ceuci_agent):
        ...
        message = AgentMessage(
            sender="test", recipient="Ceuci", action="analyze_cultural_context",
    ...
    async def test_social_cohesion_evaluation(self, ceuci_agent):
        ...
        message = AgentMessage(
            sender="test", recipient="Ceuci", action="evaluate_social_cohesion",
