...
class TestBonifacioAgent:
    ...
    @pytest.mark.unit
    async def test_policy_effectiveness_analysis_with_dict(self, bonifacio_agent, agent_context):
    ...
    async def test_policy_analysis_with_string(self, bonifacio_agent, agent_context):
        ...
        assert response.success is True
        assert response.data["policy_evaluation"]["policy_name"] == "Programa Bolsa Família"
    
    @pytest.mark.unit
    async def test_effectiveness_score_calculation(self, bonifacio_agent, agent_context):
    ...
    async def test_strategic_recommendations(self, bonifacio_agent, agent_context):
        ...
        budget_rec = next((r for r in recommendations if r["area"] == "budget_management"), None)
    ...
    async def test_sustainability_assessment(self, bonifacio_agent, agent_context):
        ...
        sustainability_score = response.data["policy_evaluation"]["sustainability_score"]
