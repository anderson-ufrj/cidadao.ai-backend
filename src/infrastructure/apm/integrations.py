...
from .hooks import APMEvent, APMError, APMPerformanceMetric, apm_hooks
...
class ElasticAPMIntegration:
    ...
    def __init__(self, server_url: str, secret_token: Optional[str] = None, service_name: str = "cidadao-ai"):
...
class APMIntegrations:
    ...
    def setup_newrelic(self, license_key: str, app_name: str = "cidadao-ai", account_id: Optional[str] = None):
    ...
    def setup_elastic_apm(self, server_url: str, secret_token: Optional[str] = None, service_name: str = "cidadao-ai"):
