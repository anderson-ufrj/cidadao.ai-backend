...
AGENT_VOICE_PROFILES = {
    ...
    "zumbi": AgentVoiceProfile(
        ...
        voice_name="pt-BR-Neural2-B",  # Male, very natural (upgraded from Wavenet)
        gender=VoiceGender.MALE,
        quality=VoiceQuality.NEURAL2,
    ...
    "drummond": AgentVoiceProfile(
        ...
        voice_name="pt-BR-Neural2-A",  # Female, very natural (upgraded, default)
        gender=VoiceGender.FEMALE,
        quality=VoiceQuality.NEURAL2,
    ...
    "nana": AgentVoiceProfile(
        ...
        voice_name="pt-BR-Neural2-A",  # Female, very natural (upgraded from Wavenet)
        gender=VoiceGender.FEMALE,
        quality=VoiceQuality.NEURAL2,
