...
class MetricsCollector:
    ...
    def record_agent_task(self, agent: str, task_type: str, status: str, duration: float):
    ...
    @asynccontextmanager
    async def trace_operation(self, operation_name: str, attributes: Optional[Dict] = None):
