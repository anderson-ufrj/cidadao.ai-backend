...
class TestInvestigationEndpoints:
            ...
            with patch("src.agents.abaporu.MasterAgent.execute") as mock_execute:
                ...
                response = client.post(
                    ...
                    json={
                        ...
                        "target_entity": "Ministry of Health",
                        "parameters": {"year": 2024, "min_value": 100000},
                    },
                )
    ...
    def test_list_investigations(self, client, authenticated_headers, mock_db):
        ...
        with patch("src.api.routes.investigations.get_db", return_value=mock_db):
            response = client.get(
                "/api/v1/investigations", headers=authenticated_headers
            )
    ...
    def test_get_investigation_by_id(
        self, client, authenticated_headers, mock_db, mock_investigation
    ):
    ...
    def test_get_investigation_not_found(self, client, authenticated_headers, mock_db):
        ...
        with patch("src.api.routes.investigations.get_db", return_value=mock_db):
            response = client.get(
                "/api/v1/investigations/non-existent-id", headers=authenticated_headers
            )
    ...
    def test_investigation_websocket(self, client, authenticated_headers):
        ...
        with client.websocket_connect(
            "/api/v1/investigations/ws/inv-123", headers=authenticated_headers
        ) as websocket:
...
class TestAnalysisEndpoints:
    ...
    def test_analyze_contracts(self, client, authenticated_headers):
        ...
        with patch(
            "src.services.analysis_service.AnalysisService.analyze_contracts"
        ) as mock_analyze:
            ...
            response = client.post(
                ...
                headers=authenticated_headers,
                json={"entity_code": "26000", "year": 2024, "min_value": 100000},
            )
    ...
    def test_analyze_spending_patterns(self, client, authenticated_headers):
        ...
        with patch(
            "src.services.analysis_service.AnalysisService.analyze_spending"
        ) as mock_analyze:
            mock_analyze.return_value = {
                "patterns": [
                    {
    ...
    def test_vendor_concentration_analysis(self, client, authenticated_headers):
        ...
        response = client.post(
            ...
            headers=authenticated_headers,
            json={"entity_code": "26000", "year": 2024, "concentration_threshold": 0.7},
        )
...
class TestReportEndpoints:
    ...
    def test_generate_investigation_report(self, client, authenticated_headers):
        ...
        with patch(
            "src.agents.tiradentes.ReporterAgent.generate_report"
        ) as mock_generate:
            ...
            response = client.post(
                ...
                headers=authenticated_headers,
                json={"format": "markdown", "include_evidence": True},
            )
    ...
    def test_export_report_pdf(self, client, authenticated_headers):
        ...
        with patch(
            "src.services.report_service.ReportService.export_pdf"
        ) as mock_export:
        ...
        assert (
            ...
            == 'attachment; filename="investigation_inv-123.pdf"'
        )
...
class TestAuditEndpoints:
    ...
    def test_get_audit_logs_unauthorized(self, client, authenticated_headers):
        ...
        response = client.get("/api/v1/audit/logs", headers=authenticated_headers)
