...
class TestCacheEntry:
    ...
    def test_cache_entry_creation(self):
        ...
        entry = CacheEntry(
            key="test_key", value={"data": "test"}, ttl=3600, level=CacheLevel.L1_MEMORY
        )
    ...
    def test_cache_entry_expiration(self):
        ...
        entry = CacheEntry(key="expire_test", value="data", ttl=1)
...
class TestCacheSystem:
    ...
    async def test_cache_key_generation(self):
        ...
        complex_key = CacheKey.generate(
            "investigation", "abc-123", params={"year": 2024, "entity": "26000"}
        )
...
class TestCacheDecorator:
    ...
    async def test_cache_decorator_key_func(self, cache_system):
        ...
        @cache_system.cache(ttl=60, key_func=lambda user_id, _: f"user:{user_id}")
