...
def mock_social_data_service():
    ...
    service.get_demographic_data.return_value = {
        ...
        "geographic_distribution": {"urban": 0.85, "rural": 0.15},
    }
...
@pytest.fixture
def dandara_agent(
    mock_social_data_service, mock_policy_database, mock_statistical_engine
):
    """Create Dandara agent with mocked dependencies."""
    with (
        patch(
            "src.agents.dandara.SocialDataService",
            return_value=mock_social_data_service,
        ),
...
class TestDandaraAgent:
    ...
    @pytest.mark.unit
    async def test_intersectional_discrimination_analysis(
        self, dandara_agent, agent_context
    ):
    ...
    @pytest.mark.unit
    async def test_social_justice_violation_identification(
        self, dandara_agent, agent_context
    ):
    ...
    async def test_error_handling_insufficient_data(self, dandara_agent, agent_context):
        ...
        dandara_agent.social_data_service.get_demographic_data.return_value = {
            "total_population": 0
        }
...
class TestEquityAnalysisResult:
    ...
    def test_equity_result_creation(self):
        ...
        result = EquityAnalysisResult(
            ...
            violations_detected=[
                {
                    "type": "access_discrimination",
                    "severity": "high",
                    "affected_groups": ["black", "indigenous"],
                }
            ],
            gaps_identified=[
            ...
            recommendations=[
                "Increase targeted education funding",
...
class TestDandaraIntegration:
    ...
    async def test_comprehensive_national_equity_assessment(self, dandara_agent):
        ...
        demographic_msg = AgentMessage(
            ...
            recipient="dandara",
            action="analyze_social_equity",
            payload={"analysis_scope": "national", "comprehensive_assessment": True},
        )
