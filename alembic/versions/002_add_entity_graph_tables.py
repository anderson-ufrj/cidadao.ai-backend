...
def upgrade() -> None:
    ...
    # Create indexes
    op.create_index(
        "idx_entity_type_name", "entity_nodes", ["entity_type", "normalized_name"]
    )
    ...
    op.create_index(
        "idx_relationship_suspicious", "entity_relationships", ["is_suspicious"]
    )
    ...
    # Create indexes
    op.create_index(
        "idx_reference_entity_investigation",
        "entity_investigation_references",
        ["entity_id", "investigation_id"],
    )
    op.create_index(
        "idx_reference_anomalies",
        "entity_investigation_references",
        ["involved_in_anomalies"],
    )
