...
class IntensiveTestSuite:
    ...
    async def test_all_agents(self):
        ...
        # Corrigindo nomes dos endpoints
        agents = [
            "zumbi",
            "anita",
            "tiradentes",
            "bonifacio",
            "maria-quiteria",  # Corrigido: hífen ao invés de underscore
            "machado",
            "dandara",
            "lampiao",
            "oscar",
        ...
        for scenario in error_scenarios:
            ...
            try:
                ...
                if result["has_error_message"]:
                    ...
                    self.print_warning("Resposta sem mensagem de erro clara")
    ...
    async def generate_report(self):
        ...
        # Salva relatório
        report_file = "/home/anderson-henrique/Documentos/cidadao.ai/cidadao.ai-backend/reports/frontend_readiness_report.json"
