...
from ..core.exceptions import DataNotFoundError, TransparencyAPIError
...
class APITester:
    ...
    async def test_api_connection(self) -> bool:
        ...
        try:
            ...
            filters = TransparencyAPIFilter(ano=2024, tamanho_pagina=1)
            ...
            self._log_test_result("API Connection", False, {"error": str(e)})
            return False
    ...
    async def test_contracts_endpoint(self) -> bool:
        ...
        try:
            ...
            filters = TransparencyAPIFilter(ano=2024, tamanho_pagina=5)
            ...
            self._log_test_result(
                ...
                success,
                {
                    ...
                    "sample_fields": (
                        list(response.data[0].keys()) if response.data else []
                    ),
                },
            )
            return success
            ...
            self._log_test_result("Contracts Endpoint", False, {"error": str(e)})
            return False
    ...
    async def test_expenses_endpoint(self) -> bool:
        ...
        try:
            ...
            filters = TransparencyAPIFilter(ano=2024, mes=1, tamanho_pagina=5)
            ...
            self._log_test_result("Expenses Endpoint", False, {"error": str(e)})
            return False
    ...
    async def test_biddings_endpoint(self) -> bool:
        ...
        try:
            ...
            filters = TransparencyAPIFilter(ano=2024, tamanho_pagina=3)
            ...
            self._log_test_result("Biddings Endpoint", False, {"error": str(e)})
            return False
    ...
    async def test_rate_limiting(self) -> bool:
        ...
        try:
            ...
            self._log_test_result("Rate Limiting", False, {"error": str(e)})
            return False

    async def test_data_quality(self) -> bool:
        """Test data quality and structure."""
        try:
            filters = TransparencyAPIFilter(ano=2024, tamanho_pagina=10)

            response = await self.client.get_contracts(filters)

            if not response.data:
                self._log_test_result(
                    "Data Quality", False, {"error": "No data returned"}
                )
                return False
            ...
            self._log_test_result("Data Quality", False, {"error": str(e)})
            return False
    ...
    async def test_error_handling(self) -> bool:
        ...
        try:
            ...
            filters = TransparencyAPIFilter(ano=1900, tamanho_pagina=1)  # Invalid year
            ...
            self._log_test_result(
                "Error Handling", success, {"error_message": error_msg}
            )
            return success

        except Exception as e:
            self._log_test_result("Error Handling", False, {"error": str(e)})
            return False
    ...
    async def run_all_tests(self) -> dict[str, Any]:
        ...
        logger.info(
            f"📊 Test suite completed: {passed}/{total} tests passed ({summary['success_rate']:.1f}%)"
        )
